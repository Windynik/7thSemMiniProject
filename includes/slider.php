                        ...
                        <div class="container">
                                <div class="carousel-caption">
                                    <div class="col-sm-6 col-md-6">
                                    	...
                                    	<h1>What are its benefits?</h1>
                                        <p>It saves time for both the teachers and the students!</p>
                                    </div>
                                    <div class="col-sm-6 col-md-6">
                                    <h1>What does it do for teachers?</h1>
                                        <p>Produces organized reports for teachers and allow for automated attendance taking.</p>
                                    </div>
                                </div>
                        </div>
                    </div>
